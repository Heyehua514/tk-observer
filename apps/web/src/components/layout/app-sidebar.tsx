...
export function AppSidebar() {
  ...
  return (
    <Sidebar collapsible={collapsible} variant={variant}>
      <SidebarHeader className='h-[4.5rem] justify-center border-b border-sidebar-border/70 bg-sidebar/80 px-4 backdrop-blur-xl'>
        <Link to='/overview' className='flex min-w-0 items-center gap-3'>
          ...
          <span className='truncate font-semibold tracking-[0.01em] group-data-[collapsible=icon]:hidden'>
            TK观察工作台
          </span>
        </Link>
      </SidebarHeader>
